...
| <a name="input_name"></a> [name](#input\_name) | The name of the Google project-level logging sink.<br/>If individual names are not provided in a relevant vars, this name is used. | `string` | `"ef-collector"` | no |
